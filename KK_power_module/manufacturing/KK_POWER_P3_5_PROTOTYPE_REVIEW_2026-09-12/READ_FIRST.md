# P3 — five engineering samples, not a production approval

Current project: KK_power_module/P3_matching_stack. Open cad/KK_power_module.kicad_pro in KiCad 10 with its standard footprint/3D libraries installed. Local custom symbols, footprints, models and source datasheets are included. Do not use older 84x95 main or 50x50 power outputs. Both revised boards are 96x105 mm; MAIN HAS TWO COPPER LAYERS, POWER HAS FOUR.
