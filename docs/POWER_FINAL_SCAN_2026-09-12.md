...
**Historical P.2 scan.** Current C.6/P.3 source hashes and packages are in [the release index](C6_P3_RELEASE_INDEX.json). Use [P.3 assembly/bench instructions](../KK_power_module/P3_matching_stack/assembly/P3_REVIEW_AND_TEST.md); old package links and coordinates below describe the archived revision.
