...
**Historical P.2 report.** For the current 96 × 105 mm P.3 stack, coordinates, assembly and first-power-up, use [P.3 review](../KK_power_module/P3_matching_stack/assembly/P3_REVIEW_AND_TEST.md). The original P.2 findings below are preserved, not current build instructions.
