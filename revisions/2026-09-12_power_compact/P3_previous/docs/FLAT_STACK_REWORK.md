...
- Main: `KK_main_module/KK_main_module.kicad_pro`
- Power: `KK_power_module/KK_power_module.kicad_pro`
- Printable review: [C6_P3_STACK_REVIEW.pdf](C6_P3_STACK_REVIEW.pdf)
- Main current BOM: `KK_main_module/assembly/C6_BOM_BY_REFERENCE.csv`
- Main changes: `KK_main_module/component_changes.json`
...
Actual-size main-board fit PDFs: [front](../KK_main_module/assembly/C6_front_FIT_100_PERCENT.pdf), [back](../KK_main_module/assembly/C6_back_FIT_100_PERCENT.pdf). Updated power assembly-coordinate table: [P.3 BOM/placement review](../KK_power_module/assembly/P3_BOM_AND_PLACEMENT_REVIEW.csv). The ordinary main-board assembly CSV contains quantities/parts, not factory-ready SMT pick-and-place data.
