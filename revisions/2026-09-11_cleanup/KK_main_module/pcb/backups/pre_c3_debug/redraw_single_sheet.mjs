...
txt('ONE-SHEET CIRCUIT VIEW   |   C.2: low-current MOSFET amplifier switch   |   Engineering prototype',6,11,1.6);
...
group('READING THIS DRAWING',243,179,82,40);
txt('Follow the green wires within each group.\nMatching signal names connect between groups.\nDots mark joined wires; crossings without dots do not join.\nC.2 changes Q5/Q6 and R36/R38; use the C.2 BOM.\n\nStill a prototype: module pinout/power, backlight,\nmotor startup and speaker tests remain outstanding.\nNo charging circuit or power-board changes here.',246,188,1.45);
...
fs.writeFileSync(path.join(out,'KK_main_module.kicad_sch'),`(kicad_sch(version 20250114)(generator "eeschema")(generator_version "9.0")(uuid ${q(root)})(paper "A1")
 (title_block(title "Main board - grouped wired schematic")(date "2026-09-10")(rev "C.2 / MOSFET audio switch")(company "Keychain Kreatures")(comment 1 "Engineering prototype; bench qualification required"))
