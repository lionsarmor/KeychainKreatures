# Required DFM response — 5 × P.2 power modules

**Historical P.2 fabrication request.** Do not order the old outline. Current requirements are [P.3 fabrication requirements](../KK_power_module/P3_matching_stack/FABRICATION_REQUIREMENTS.md), with matching C.6/P.3 package links in [START_HERE](../START_HERE.md).
...
| Board | 50 × 50 mm, 1.6 mm nominal, R3 corners, four 2.2 mm M2 clearance holes |
...
| Via identification | `CAD_AUDIT.json` lists via centers inside front SMD lands; evaluate all land/via overlaps from CAD/Gerbers, including partial overlaps |
