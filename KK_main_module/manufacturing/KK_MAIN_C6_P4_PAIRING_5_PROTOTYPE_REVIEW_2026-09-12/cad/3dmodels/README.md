...
Speaker, motor, battery, wires, mating JST plugs and case are not shown at invented positions. All need a physical fit mock-up. Compact power P.4 requires separate case supports, not the superseded shared-hole 20 mm spacer arrangement; verify actual plugged-connector clearance. RGB socket grip on real LED leads remains unqualified. Do not force or tin mating contacts. Trim solder tails to <=2.5 mm.
