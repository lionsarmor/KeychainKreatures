# C6 — five engineering samples; not production approval

Current editable project: KK_main_module at the repository root. This package is the C6/P4 pairing release. Open cad/KK_main_module.kicad_pro with KiCad 10 and its standard libraries. Custom assets and selected datasheets are included.
