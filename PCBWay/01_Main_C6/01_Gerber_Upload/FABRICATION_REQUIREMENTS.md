# C.6 main — five bare prototype PCBs
...
Engineering prototype only. Confirm actual part fit, socket retention, inter-board plug/wire clearance and fabrication DFM before ordering. Main C.6 pairs with power P.4; do not mix older C.5/P.2 Gerbers.
